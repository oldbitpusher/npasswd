h05412
s 00015/00008/00936
d D 1.5 97/07/14 14:32:08 clyde 5 4
c Validate email address provided in form
e
s 00003/00001/00941
d D 1.4 97/05/28 16:36:43 clyde 4 3
c Enlarge registry display box
e
s 00005/00001/00937
d D 1.3 97/05/20 11:24:43 clyde 3 2
c On admin page, add mailto URL for folks in registry
e
s 00002/00001/00936
d D 1.2 97/05/19 14:14:05 clyde 2 1
c Tell me how many registry entries (admin page0
e
s 00937/00000/00000
d D 1.1 97/05/15 11:56:56 clyde 1 0
c date and time created 97/05/15 11:56:56 by clyde
e
u
U
f e 0
...
sub DoAdmin {
	...
	print "<hr>\n";
D 2
	print $theQuery->h2("Registry entries");
E 2
I 2
...
E 2
D 4
	print '<SELECT NAME="id_pick" SIZE="3">';
E 4
I 4
...
D 5
		if ($tmp =~ /(.*)@(.*)/) {
			# my $ename = $1;
			# my $ehost = $2;
	#	Test disabled until can look up MX records
	#		$FormError = "Unknown host $ehost"
	#			unless (gethostbyname($ehost));
E 5
I 5
