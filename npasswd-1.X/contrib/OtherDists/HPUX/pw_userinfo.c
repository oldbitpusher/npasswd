 ...
 */
#ifndef lint
static char sccsid[] = "@(#)pw_userinfo.c	1.2 6/5/89 (cc.utexas.edu) /home/emx/u2/cc/clyde/src/new/npasswd/SCCS/s.pw_userinfo.c";
#endif
...
#ifdef HPUX 
	memset((void *)&theUser, 0,  sizeof(theUser));
