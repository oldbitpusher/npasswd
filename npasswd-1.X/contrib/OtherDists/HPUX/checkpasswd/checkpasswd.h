 ...
 * 
 *	@(#)checkpasswd.h	1.3 10/4/89 (cc.utexas.edu) /usr/src/ut/bin/passwd/checkpasswd/SCCS/s.checkpasswd.h
 */
 ...
 */
#define	DEFAULT_DICT	"/usr/local/dict/words"	 /*Default dictionary */
