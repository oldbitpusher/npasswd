 ...
 */
#ifndef lint
static char sccsid[] = "@(#)util.c	1.6 2/18/92 (cc.utexas.edu)";
#endif
...
char	*filename;
{
	...
	extern int	PWCK_standalone;	/* Am I a standalone application? */
...
#ifdef DEBUG
				int i;
				printf("appending to illegalcc\n");
				printf("the illegal chars are:\n");
				for(i=0; i < strlen(xcc); i++) 
				    printf("%o = \"%c\"\n",xcc[i],xcc[i]);
#endif
